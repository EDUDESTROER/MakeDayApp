...
- Front-end validation is done manually to demonstrate logical mastery and improve the user experience.

- On back-end validation library is used to ensure security, data integrity, and scalability.
